...
#'
#'
#' @param slugIDs Valid slug IDs (should be four digits, either characters or numerical). Users can supply can either one slug ID or multiple slug IDs.
#'                See slugInfo for a list of valid slug IDs and report-specific structure.
#' @param report_time A valid date(s) associated with slug ID. For LMPR and DPMRP, a specific date should be supplied, such as
...
mpr_request <- function(slugIDs, report_time = NULL, message = TRUE){
